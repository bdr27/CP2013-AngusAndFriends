...
{
    public class EditDentistThread : ThreadTemplate, IPostHTTPRequest
    {
        public EditDentistThread(int timerAmount, object o)
            : base(timerAmount, o)
        {
            successMessage = "You have successfully edited the dentist!";
        ...
        protected override void ThreadMethod()
        {
            try
            {
                ...
                var response = PostHttpRequest(new HttpPostEditDentist(), jsonData);
