...
{
    public class AllAvailableTimesThread : ThreadTemplate, IGetJsonResponse
    {
        private List<TimeSlot> timeslots;

        public AllAvailableTimesThread(int timerAmount, object o)
            : base(timerAmount, o)
        {
        ...
        protected override void ThreadMethod()
        {
            try
            {
                var response = GetJsonResponse(new JsonEveryTimeSlot(), new HttpGetAllAvaliableTimes(), information);
